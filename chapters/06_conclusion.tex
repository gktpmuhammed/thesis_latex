...
\begin{enumerate}
    ...
    \item Explore organ-adaptive token allocation for long-tail organs.
    \item Improve sparse-organ handling with uncertainty-aware generation and decomposition confidence weighting.
    \item Study additional bridge regularization to reduce visual-text embedding drift.
\end{enumerate}
